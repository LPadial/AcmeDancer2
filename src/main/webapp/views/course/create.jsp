...
<security:authorize access="hasRole('ACADEMY')">
	...
	<acme:acme_form url="course/academy/save-create.do" skip_fields="levelCourse,time,style,stageCourse"
		...
		<div class="form-group" style="width: 55%;">
			<label for="label"><spring:message code='course.stageCourse' /></label>
			<select name="stageCourse">
