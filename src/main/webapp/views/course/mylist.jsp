...
<security:authorize access="hasRole('ACADEMY')">
	...
	<acme:list list="${courses}" requestURI="course/academy/mylist.do"
		hidden_fields="id,version,academy" field_mapping="{levelCourse:value,stageCourse:courseValue}"
		time_stamps="{time:hh mm,start:dd/MM/yyyy,end:dd/MM/yyyy}"
		entityUrl="{style:style/list.do,applications:application/academy/listByCourse.do}"
